...
class StatusOverridePage extends Component
{
    ...
    protected function statusMap(): array
    {
        return [
            ...
            'vp_approved' => ['step' => 'ed_manager_acceptance', 'owner_role' => 'ed_manager', 'owner_id' => null, 'is_terminal' => false, 'lock' => true],
            'accepted' => ['step' => 'dh_gen_services_noting', 'owner_role' => 'dh_gen_services', 'owner_id' => null, 'is_terminal' => false, 'lock' => true],
            'noted' => ['step' => 'engineer_initialization', 'owner_role' => 'engineer', 'owner_id' => null, 'is_terminal' => false, 'lock' => true],
            'initialized' => ['step' => 'completed', 'owner_role' => null, 'owner_id' => null, 'is_terminal' => true, 'lock' => true],
            'jl_pending' => ['step' => 'division_head_jl_review', 'owner_role' => 'division_head', 'owner_id' => null, 'is_terminal' => false, 'lock' => false],
            'jl_approved' => ['step' => 'ed_manager_acceptance', 'owner_role' => 'ed_manager', 'owner_id' => null, 'is_terminal' => false, 'lock' => true],
    ...
    public function render()
    {
        return view('livewire.it-admin.status-override-page')
            ->layout('layouts.app', [
                'title' => 'Status Override | Project Initialization System',
