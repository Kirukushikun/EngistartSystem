...
abstract class SettingsChangeRequestBase extends Component
{
    public array $form = [
        'setting' => '',
        'newValue' => '',
    ...
    abstract protected function confirmEventName(): string;

    abstract protected function submittedViaKey(): string;
    ...
    public function openSubmissionReview(): void
    {
        ...
        $this->dispatch('openConfirmationModal', config: [
            ...
            'confirmEvent' => $this->confirmEventName(),
            ...
            $projectRequest = ProjectRequest::create([
                ...
                'meta' => [
                    'setting_change' => [
                        ...
                        'submitted_via' => $this->submittedViaKey(),
                    ],
                ],
            ]);
    ...
    {
        return SettingsCatalog::optionsWithCurrentValues();
    }
