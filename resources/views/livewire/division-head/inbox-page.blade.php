...
@section('title', 'For Recommendation | EngiStart')
@section('header', 'For Recommendation')
@section('subheader', 'Review incoming project requests and recommend them for approval.')

@section('sidebar')
    <a href="{{ route('division-head.inbox') }}"
...
@section('sidebarFooter')
    ...
    <p class="text-xs font-medium leading-tight text-apis-text">Div. Head Santos</p>
    <p class="mt-0.5 text-[11px] text-apis-blue">Division Head</p>
@endsection
...
<div class="p-6 overflow-y-auto h-full">
    <div class="w-full">
            ...
            <div class="grid grid-cols-1 md:grid-cols-[minmax(0,1.5fr)_180px_180px] gap-3 flex-1 w-full">
                <div>
                    ...
                    <input type="text"
                           ...
                           class="apis-toolbar-control apis-toolbar-search"
                ...
                <div>
                    ...
                    <select wire:model.live="typeFilter" class="apis-toolbar-control w-full">
        ...
        <div class="mt-4 rounded-[12px] p-[12px_14px] flex flex-col gap-3 md:flex-row md:items-center md:justify-between"
             style="border: 0.5px solid var(--border); background: var(--bg)">
            <p class="text-[12px] text-apis-text2 m-0">
                Showing {{ $this->showingFrom }}-{{ $this->showingTo }} of {{ $this->filteredInboxItems->count() }} request{{ $this->filteredInboxItems->count() !== 1 ? 's' : '' }}
            </p>
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="text-[12px] text-apis-text2 px-1">
