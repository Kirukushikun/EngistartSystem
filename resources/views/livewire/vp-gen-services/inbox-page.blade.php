            ...
            <div class="apis-card" x-data="{ open: false }">
                ...
                <div x-cloak x-show="open" class="border-t p-[16px_18px]" style="border-color: var(--border)">
                    ...
                    @include('partials.apis.remarks-section', [
                        ...
                        'textareaPlaceholder' => 'Add VP approval or rejection remarks here...',
                    ])

                    <div class="flex gap-2 flex-wrap">
                        @if ($request['isPendingHere'])
                            <button type="button"
 wire:click="confirmApprove(@js($request['id']))" class="apis-card-button font-medium" style="background: var(--green-bg); color: var(--green); border: 0.5px solid var(--green-bd)">Approve</button>
